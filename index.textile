...
p(grid_4 alpha). You can install the "latest stable release":https://github.com/downloads/MacRuby/MacRuby/MacRuby%200.12.zip or, if you are feeling adventurous, you can install one of the "nightly builds":https://macruby.macosforge.org/files/nightlies. See the wiki for "more detailed instructions":https://github.com/MacRuby/MacRuby/wiki/Setting-up-MacRuby.
